...
The PNG files in this directory are reproducible captures of the actual Next.js application in its clearly labeled fixture mode. They follow the mocked provider walkthrough through the owner setup checklist, a 40 USDC execution, a 70 USDC on-chain refusal, and a cited grounded answer. Every capture carries the persistent `FIXTURE MODE` banner. They are not evidence of a live Arc, Privy, or The Graph integration.
